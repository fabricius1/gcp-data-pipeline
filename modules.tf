...
module "bucket-raw" {
  ...
  name       = "fabricio-data-pipeline-stack-combustiveis-brasil-raw"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-curated" {
  ...
  name       = "fabricio-data-pipeline-stack-combustiveis-brasil-curated"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-pyspark-tmp" {
  ...
  name       = "fabricio-data-pipeline-stack-combustiveis-brasil-pyspark-tmp"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-pyspark-code" {
  ...
  name       = "fabricio-data-pipeline-stack-combustiveis-brasil-pyspark-code"
  project_id = var.project_id
  location   = var.region
}